      ...
      <div class="flex flex-col items-center justify-center h-dvh w-full bg-blue-950 text-white">
        ...
        <form class="form-container flex flex-col w-[300px] h-[200px]" @submit.prevent="resetPassword">
          <div class="mb-4 w-[300px] flex flex-col">
            ...
            <input type="password" id="newPassword" v-model="newPassword" class=" text-gray-300 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
          </div>

          <div class="mb-4 w-[300px]">
            <label for="confirmPassword" class="mb-2">Confirm Password:</label>
            <input type="password" id="confirmPassword" v-model="confirmPassword" class="text-gray-300 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
          </div>
