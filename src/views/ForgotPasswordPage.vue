        ...
        <br><br>
            <form class="form-container" @submit.prevent="sendEmail">
                <div v-if="IsSend == false" class="form-container flex flex-col w-[300px] h-[200px]">
                    ...
                    <input type="email" id="email" name="email" required class="border text-black border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" v-model="email">
                    <br>
