                          ...
                          <div class="modal-box">
                            ...
                            <div class="flex justify-center flex-col">
                                <label class="form-control w-full">
                                  ...
                                  <input maxlength="11" type="text" placeholder="Change to..." class="input input-bordered w-full max-w-xs" v-model="wof" />
                                </label>
                                <label class="form-control w-full mt-4">
                                  <div class="label">
                                    <span class="label-text">daily wage of Work Form Home (Now is {{ configsalary.WFH }})</span>
                                  </div>
                                  <input maxlength="11" type="text" placeholder="Change to..." class="input input-bordered w-full max-w-xs" v-model="wfh" />
                                </label>
                            </div>
